<script lang="ts">
    ...
    import { broadcastTypes,  listStore, SignalListItem } from "$stores/listStore.svelte";
            ...
            <Card.Content>
                <div class="grid grid-cols-2">
                    ...
                    <div class="flex flex-col space-y-1.5">
                        ...
                        <BroadcastTypeSelect id="broadcastType" onselect={broadcastTypeSelected} broadcastType={item.broadcastType} />
                    </div>
                </div>
            </Card.Content>
            <!-- <Card.Footer>
